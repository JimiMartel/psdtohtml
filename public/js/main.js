...
function openMenu() {
    if(counter === 0) {
        for(let i = 0; i < navListElements.length; i++) {
            //navListElements[i].style.display = 'block';
            navListElements[i].style.visibility = 'visible';
        ...
        for(let i = 0; i < navListElements.length; i++) {
            //navListElements[i].style.display = '';
            navListElements[i].style.visibility = 'hidden';
